...
Lignende test kan foretages for alle syv former for engagement, der er inkluderet i data. Hvis alle kombinationerne skulle testet skulle vi teste 7 gange for hver af de tre metoder (MK, Wii og HMD) samt 7 gange for hver af de tre minut-angivelser (5, 15 og 30), dvs. 42 test i alt. Vi har valgt nogle få ud [måske er det nok med de to test ovenfor?] RESULTATER
