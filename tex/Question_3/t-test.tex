...
\begin{figure}[t]
	...
	\caption{\textit{{\footnotesize Results from a Bartlett's test for equal variances. In the statistics \ref{subfig:2-1-1_stats} the p-value indicates that difference in the variances from the two samples are non-significant at the 0.05 level.}}}
...
\begin{figure}[h]
	...
	\caption{\textit{{\footnotesize Results from a Bartlett's test for equal variances.}}}
